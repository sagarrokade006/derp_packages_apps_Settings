...
public class BatteryChargeSoundSettings extends SettingsPreferenceFragment implements
    ...
    private SwitchPreferenceCompat mBatteryLevelChargeAlarmEnabled;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBatteryLevelChargeAlarmEnabled = (SwitchPreferenceCompat) findPreference(KEY_BATTERY_LEVEL_CHARGE_ALARM_ENABLED);
